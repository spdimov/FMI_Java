...
@snap [south span-100] @[2](constant) @[3](static%20member)
...
-   Множеството текущи стойности на член-данните на даден обект се
...
@snap [south span-100] @[3-4](Stays%20hidden.) @[14-14](Won't compile)
@snapend
